...
class right_panel():
    ...
    size: tuple[int, int] = (90, 400)
    destination: tuple[int, int] = (1100, 500)
    button_timer: int = 0

    def check_in_region(self, top_left, bottom_right, point):
        if top_left[1] < point[1] < bottom_right[1] and top_left[0] < point[0] < bottom_right[0]:  # Check if point
    ...
    def __init__(self, active):
        ...
        self.draw.text((18, 55), "Меню", (60, 60, 60, 10),
                       font=ImageFont.truetype("applications/resources/sans-serif.ttf", 20))
        ...
        self.draw.text((23, 165), "Настрой", (60, 60, 60, 10),
                       font=ImageFont.truetype("applications/resources/sans-serif.ttf", 12))
        ...
        self.draw.text((23, 360), "Выход", (60, 60, 60, 10),
                       font=ImageFont.truetype("applications/resources/sans-serif.ttf", 15))
        pass
    ...
    def controller(self,
                   coordinates):  # Здесь пишем что исполняется по нажатию на кнопку. При этом coordinates - координата указательного пальца НА ПОЛОТНЕ ОБЪЕКТА (self.size)
